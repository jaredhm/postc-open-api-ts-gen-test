...
export class UserSearchService {
     ...
     * @throws ApiError
     */
    public findBulkAssignableUsers(
        projectKeys: string,
        query?: string,
        username?: string,
        accountId?: string,
     ...
     * @throws ApiError
     */
    public findUsersWithAllPermissions(
        permissions: string,
        query?: string,
        username?: string,
        accountId?: string,
     ...
     * @throws ApiError
     */
    public findUsersWithBrowsePermission(
        query?: string,
        username?: string,
        accountId?: string,
        issueKey?: string,
