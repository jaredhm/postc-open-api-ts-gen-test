...
export class WorkflowTransitionPropertiesService {
     ...
     * @throws ApiError
     */
    public getWorkflowTransitionProperties(
        transitionId: number,
        workflowName: string,
     ...
     * @throws ApiError
     */
    public updateWorkflowTransitionProperty(
        transitionId: number,
        key: string,
        workflowName: string,
     ...
     * @throws ApiError
     */
    public createWorkflowTransitionProperty(
        transitionId: number,
        key: string,
        workflowName: string,
        requestBody: WorkflowTransitionProperty,
     ...
     * @throws ApiError
     */
    public deleteWorkflowTransitionProperty(
        transitionId: number,
        key: string,
        workflowName: string,
        workflowMode?: 'live' | 'draft',
