...
export class JqlService {
     ...
     * @throws ApiError
     */
    public getAutoComplete(): CancelablePromise<JQLReferenceData> {
     ...
     * @throws ApiError
     */
    public getFieldAutoCompleteForQueryString(
        fieldName?: string,
        fieldValue?: string,
