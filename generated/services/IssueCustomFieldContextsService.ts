...
export class IssueCustomFieldContextsService {
     ...
     * @throws ApiError
     */
    public getIssueTypeMappingsForContexts(
        fieldId: string,
        contextId?: Array<number>,
        startAt?: number,
        maxResults: number = 50,
     ...
     * @throws ApiError
     */
    public getCustomFieldContextsForProjectsAndIssueTypes(
        fieldId: string,
     ...
     * @throws ApiError
     */
    public getProjectContextMapping(
        fieldId: string,
        contextId?: Array<number>,
        startAt?: number,
        maxResults: number = 50,
     ...
     * @throws ApiError
     */
    public updateCustomFieldContext(
        fieldId: string,
        contextId: number,
     ...
     * @throws ApiError
     */
    public deleteCustomFieldContext(
        fieldId: string,
        contextId: number,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
     ...
     * @throws ApiError
     */
    public removeIssueTypesFromContext(
        fieldId: string,
        contextId: number,
        requestBody: IssueTypeIds,
    ): CancelablePromise<void> {
     ...
     * @throws ApiError
     */
    public assignProjectsToCustomFieldContext(
        fieldId: string,
        contextId: number,
     ...
     * @throws ApiError
     */
    public removeCustomFieldContextFromProjects(
        fieldId: string,
        contextId: number,
        requestBody: ProjectIds,
    ): CancelablePromise<void> {
