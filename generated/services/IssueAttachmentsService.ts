...
export class IssueAttachmentsService {
     ...
     * @throws ApiError
     */
    public getAttachmentMeta(): CancelablePromise<AttachmentSettings> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public expandAttachmentForHumans(
        id: string,
     ...
     * @throws ApiError
     */
    public expandAttachmentForMachines(
        id: string,
