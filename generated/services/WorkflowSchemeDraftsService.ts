...
export class WorkflowSchemeDraftsService {
     ...
     * @throws ApiError
     */
    public createWorkflowSchemeDraftFromParent(
        id: number,
     ...
     * @throws ApiError
     */
    public updateWorkflowSchemeDraft(
        id: number,
     ...
     * @throws ApiError
     */
    public deleteWorkflowSchemeDraft(
        id: number,
     ...
     * @throws ApiError
     */
    public getDraftDefaultWorkflow(
        id: number,
     ...
     * @throws ApiError
     */
    public updateDraftDefaultWorkflow(
        id: number,
     ...
     * @throws ApiError
     */
    public deleteDraftDefaultWorkflow(
        id: number,
    ): CancelablePromise<WorkflowScheme> {
        return this.httpRequest.request({
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public getWorkflowSchemeDraftIssueType(
        id: number,
        issueType: string,
     ...
     * @throws ApiError
     */
    public setWorkflowSchemeDraftIssueType(
        id: number,
        issueType: string,
     ...
     * @throws ApiError
     */
    public deleteWorkflowSchemeDraftIssueType(
        id: number,
        issueType: string,
    ): CancelablePromise<WorkflowScheme> {
        return this.httpRequest.request({
     ...
     * @throws ApiError
     */
    public updateDraftWorkflowMapping(
        id: number,
        workflowName: string,
     ...
     * @throws ApiError
     */
    public deleteDraftWorkflowMapping(
        id: number,
        workflowName: string,
