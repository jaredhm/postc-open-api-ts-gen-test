...
export class IssueFieldConfigurationsService {
     ...
     * @throws ApiError
     */
    public getAllFieldConfigurations(
        startAt?: number,
     ...
     * @throws ApiError
     */
    public createFieldConfiguration(
     ...
     * @throws ApiError
     */
    public updateFieldConfiguration(
        id: number,
        requestBody: FieldConfigurationDetails,
     ...
     * @throws ApiError
     */
    public deleteFieldConfiguration(
        id: number,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public getFieldConfigurationItems(
        id: number,
        startAt?: number,
        maxResults: number = 50,
     ...
     * @throws ApiError
     */
    public updateFieldConfigurationItems(
        id: number,
     ...
     * @throws ApiError
     */
    public getAllFieldConfigurationSchemes(
        startAt?: number,
        maxResults: number = 50,
        id?: Array<number>,
     ...
     * @throws ApiError
     */
    public createFieldConfigurationScheme(
     ...
     * @throws ApiError
     */
    public getFieldConfigurationSchemeMappings(
        startAt?: number,
        maxResults: number = 50,
     ...
     * @throws ApiError
     */
    public getFieldConfigurationSchemeProjectMapping(
     ...
     * @throws ApiError
     */
    public assignFieldConfigurationSchemeToProject(
     ...
     * @throws ApiError
     */
    public updateFieldConfigurationScheme(
        id: number,
        requestBody: UpdateFieldConfigurationSchemeDetails,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
     ...
     * @throws ApiError
     */
    public deleteFieldConfigurationScheme(
        id: number,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public setFieldConfigurationSchemeMapping(
        id: number,
     ...
     * @throws ApiError
     */
    public removeIssueTypesFromGlobalFieldConfigurationScheme(
        id: number,
