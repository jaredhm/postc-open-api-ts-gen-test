...
export class ProjectsService {
     ...
     * @throws ApiError
     */
    public deleteProjectAsynchronously(
        projectIdOrKey: string,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
            method: 'POST',
     ...
     * @returns Project Returned if the project type is updated.
     * @throws ApiError
     */
     ...
     * @throws ApiError
     */
    public getNotificationSchemeForProject(
