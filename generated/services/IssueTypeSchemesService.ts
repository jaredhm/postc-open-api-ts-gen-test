...
export class IssueTypeSchemesService {
     ...
     * @throws ApiError
     */
    public getIssueTypeSchemesMapping(
        startAt?: number,
        maxResults: number = 50,
     ...
     * @throws ApiError
     */
    public getIssueTypeSchemeForProjects(
     ...
     * @throws ApiError
     */
    public assignIssueTypeSchemeToProject(
     ...
     * @throws ApiError
     */
    public addIssueTypesToIssueTypeScheme(
        issueTypeSchemeId: number,
     ...
     * @throws ApiError
     */
    public reorderIssueTypesInIssueTypeScheme(
        issueTypeSchemeId: number,
     ...
     * @throws ApiError
     */
    public removeIssueTypeFromIssueTypeScheme(
        issueTypeSchemeId: number,
        issueTypeId: number,
    ): CancelablePromise<void> {
        return this.httpRequest.request({
