...
export class FiltersService {
     ...
     * *  filters shared with the public.
     * @param id The ID of the filter.
     * @param formData The IDs of the fields to set as columns. In the form data, specify each field as `columns=id`, where `id` is the *id* of a field (as seen in the response for [Get fields](#api-rest-api-<ver>-field-get)). For example, `columns=summary`.
     ...
     * @throws ApiError
     */
    public deleteFavouriteForFilter(
        id: number,
        expand?: string,
    ): CancelablePromise<Filter> {
        return this.httpRequest.request({
