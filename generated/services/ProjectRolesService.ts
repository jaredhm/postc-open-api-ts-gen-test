...
export class ProjectRolesService {
     ...
     * @throws ApiError
     */
    public getAllProjectRoles(): CancelablePromise<Array<ProjectRole>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/rest/api/3/role',
            errors: {
     ...
     * @throws ApiError
     */
    public partialUpdateProjectRole(
        id: number,
        requestBody: CreateUpdateRoleRequestBean,
    ): CancelablePromise<ProjectRole> {
        return this.httpRequest.request({
